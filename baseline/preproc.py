...
def convert_examples_to_features(tydi_examples, is_training, vocab_file,
  ...
  Args:
    tydi_examples: a list of `TyDiExample`s generated by `read_tydi_examples`.
...
def read_tydi_examples(input_file, is_training, max_passages, max_position,
  ...
  for entry in input_data:
    tydi_examples.append(data.to_tydi_example(entry, is_training))

  logging.info("*** # surviving examples %d ***", len(tydi_examples))
  logging.info("*** # pruned examples %d ***", non_valid_count)
  return tydi_examples
